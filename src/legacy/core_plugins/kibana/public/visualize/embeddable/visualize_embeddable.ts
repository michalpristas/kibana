...
import { APPLY_FILTER_TRIGGER, Embeddable, executeTriggerActions } from 'ui/embeddable';
...
import { EmbeddableInput, EmbeddableOutput } from 'ui/embeddable/embeddables/embeddable';
import {
  Filter,
  VisSavedObject,
